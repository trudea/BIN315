...
tissue <- c("Skin", "Testis", "Ovaries", "Lung", "Prostate")
proj   <- c("TCGA-BRCA", "TCGA-KIRC", "TCGA-COAD", "TCGA-LUAD", "TCGA-PRAD")
for (i in 1:length(proj)) {
  ...
  idx <- sample(1:ncol(tmp.expr), 200)
  tmp.expr <- tmp.expr[,idx]
  tmp.samples <- tmp.samples[idx]
...
save(expr, classes, file = "TCGA.RData")
```
