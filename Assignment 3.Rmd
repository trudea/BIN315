...
RNA-Seq data uses counts unlike microarray data which uses intensity-concentration. Microarray data is relative to the other samples in the array whereas RNA-Seq assumes a general mean for all genes. 
...
There are genes with a lower count number with such a high variety that they are not deemed significant. 
